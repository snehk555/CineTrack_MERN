...
export const addMovieSchema = z.object({
  ...
  posterPath: z.string().url('Poster path must be a valid URL').optional(),
  backdropPath: z.string().url('Backdrop path must be a valid URL').optional(),
