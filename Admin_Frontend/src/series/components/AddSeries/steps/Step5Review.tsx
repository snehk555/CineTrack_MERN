...
import '@/movies/components/AddMovie/steps/Step6Review.css';
  ...
  return (
    <div className="step-container step6-review">
      ...
      <div className="summary-section">
        <h3 className="section-title">Review Web Series Details</h3>
        ...
        <div className="summary-card">
          ...
          <div className="summary-details">
            <h4 className="summary-title">{values.title || 'Untitled Series'}</h4>
